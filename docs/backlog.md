...
- [cite_start][ ] **BBDD-01 (P1):** Análisis de Entidades y Atributos (Juegos, Torneos, Participantes) [cite: 101-106].
- [cite_start][ ] **BBDD-02 (P1):** Diseño del Diagrama Entidad-Relación (E/R) y Modelo Relacional [cite: 108-122].
- [cite_start][ ] **BBDD-03 (P2):** Script SQL de creación (`schema.sql`) e inserción de datos (`data.sql`) [cite: 127-130].
- [cite_start][ ] **BBDD-04 (P2):** Desarrollo de consultas SQL críticas (Stock, inscritos por torneo) [cite: 132-140].
...
- [cite_start][ ] **EMP-01 (P2):** Perfil Profesional: Bio y presentación del proyecto en README [cite: 506-512].
- [cite_start][ ] **DOC-01 (P1):** Manual de instalación paso a paso en el informe de Sistemas [cite: 397-402].
- [cite_start][ ] **QA-01 (P1):** Revisión de historial de commits progresivo y descriptivo [cite: 177-184].
- [cite_start][ ] **FINAL (P1):** Entrega final antes del domingo 3 de mayo a las 23:59[cite: 731].
